...
grenade_fx = pygame.mixer.Sound('./game/audio/grenade.wav')
...
#grenade
grenade_img = pygame.image.load('./game/img/icons/grenade.png').convert_alpha()
#pick up boxes
...
grenade_box_img = pygame.image.load('./game/img/icons/grenade_box.png').convert_alpha()
item_boxes = {
...
class Soldier(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        for animation in animation_types:
            ...
            num_of_frames = len(os.listdir(f'./game/img/{self.char_type}/{animation}'))
            for i in range(num_of_frames):
                img = pygame.image.load(f'./game/img/{self.char_type}/{animation}/{i}.png').convert_alpha()
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y, scale):
        ...
        for num in range(1, 6):
            img = pygame.image.load(f'./game/img/explosion/exp{num}.png').convert_alpha()
            img = pygame.transform.scale(img, (int(img.get_width() * scale), int(img.get_height() * scale)))
